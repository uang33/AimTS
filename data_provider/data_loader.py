...
class Dataloader(Dataset):
    ...
    def __init__(self, loader, dataset_name, file_list=None, limit_size=None, flag=None):
        self.dataset_name = dataset_name
        self.all_df, self.labels_df = self.load_all(loader, dataset_name, file_list=file_list, flag=flag)
    ...
    def load_all(self, loader, dataset_name, file_list=None, flag=None):
        """
        ...
        root_path = get_file_root(loader, dataset_name)
    ...
    def __getitem__(self, ind):
        ...
        img = img_transform(img)    # C x H x W
...
def get_file_root(loader, filename):
    current_dir = os.getcwd()
    file_path = os.path.join(current_dir, '/home/yxx/AimTS/dataset')
